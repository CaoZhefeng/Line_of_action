...
from game import TwoPlayersGameState
...
class TwoPlayersGameMonteCarloTreeSearchNode(MonteCarloTreeSearchNode):
    ...
    def __init__(self, state: TwoPlayersGameState, parent):
        super(TwoPlayersGameMonteCarloTreeSearchNode, self).__init__(state, parent) #调用父类的方法
        self._number_of_visits = 0.
        self._results = defaultdict(int)

    @property
    def untried_actions(self):
        if not hasattr(self, '_untried_actions'): # 函数用于判断对象是否包含对应的属性
